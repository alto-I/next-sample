...
describe('DelayInput', () => {
  ...
  it('should display 「入力中...」 immediately after onChange event orrurs', () => {
  ...
  it('should display input text 1second after onChange event orrurs', async () => {
    const inputText = 'Text Input Text';
    const inputNode = screen.getByTestId('input-text') as HTMLInputElement;
    ...
    it('should call onChange 1second after onChange event orrurs', async () => {
      const inputText = 'Text Input Text';
      const inputNode = screen.getByTestId('input-text') as HTMLInputElement;
